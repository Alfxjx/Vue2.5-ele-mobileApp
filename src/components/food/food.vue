      ...
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings"
                        @toggle="toggleContent" @select="selectRating"></ratingselect>
            ...
            <ul v-show="food.ratings&&food.ratings.length">
              <li v-show="needShow(rating.rateType,rating.text)" v-for="(rating,index) in food.ratings" :key="index"
                ...
                <div class="user">
                  ...
                  <img :src="rating.avatar" class="avatar" width="12px">
                </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    components: {
      BScroll, cartcontrol, split, ratingselect
    }
  }
</script>
